...
export function TutorApplicationsScreen() {
  ...
  const filteredApplications = useMemo(() => {
    ...
    return applications.filter((app) => {
      ...
      return name.includes(query) || subject.includes(query) || app.id.toLowerCase().includes(query)
    })
  }, [applications, search])
  ...
  return (
    <YStack gap={24} flex={1}>
      ...
      {loading ? (
        ...
        <YStack gap={24} flex={1} flexDirection="row" flexWrap="wrap" alignItems="flex-start">
